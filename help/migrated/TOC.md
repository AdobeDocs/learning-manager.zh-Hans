...
user-guide-description: AdobeLearning Manager文档
...
* [Learning Manager用户指南](user-guide.md)
* 介绍 {#introduction}
   * [新增功能摘要](whats-new.md)
   ...
   * [Microsoft TeamsAdobeLearning Manager应用程序](adobe-learning-manager-app-microsoft-teams.md)
   * [Learning Manager的GDPR合规性](kb/prime-gdpr.md)
   * [Learning Manager中的辅助功能](accessibility-learning-manager.md)
   * [自定义域支持](custom-domain.md)
   * [AdobeLearning Manager中的Recommendations](recommendations-adobe-learning-manager.md)
   * [从AdobeFTP管理器过渡](transition-from-ftp-manager.md)
* 开始使用 {#get-started}
   ...
   * [以讲师身份开始使用Learning Manager](instructors/feature-summary/getting-started.md)
* 管理员 {#admin}
   ...
   * [创建课程模块、实例和学习计划](administrators/feature-summary/courses.md)
   ...
   * [管理Learning Manager订单和帐单](administrators/feature-summary/billing-management.md)
   ...
   * [多个SSO登录](administrators/feature-summary/multiple-sso-logins.md)
   * [配对帐户](administrators/feature-summary/peer-account.md)
   * [创建和修改技能和级别](administrators/feature-summary/skills-levels.md)
   * [基于AI的课程推荐](ai-based-recommendations.md)
   ...
   * [Learning Manager内容目录](administrators/feature-summary/content-catalogs.md)
   ...
   * [以管理员身份监视和审阅社交学习](administrators/feature-summary/social-learning-configurations-as-an-admin.md)
...
* 集成管理员 {#integration}
   ...
   * [将Learning Manager与AEM集成](integrate-aem-learning-manager.md)
   * [在Learning Manager中安装Salesforce程序包](integration-admin/feature-summary/install-salesforce-package.md)
   * [安装Microsoft Teams连接器](integration-admin/feature-summary/install-microsoft-teams-connector.md)
   * [应用程序开发人员手册](integration-admin/feature-summary/developer-manual.md)
   * [适用于Salesforce的Learning Manager应用程序](integration-admin/feature-summary/sfdc-app.md)
   * [设置](integration-admin/feature-summary/settings.md)
   * [通过CSV文件管理自定义角色](integration-admin/feature-summary/configure-role-csv-files.md)
* 作者 {#authors}
   ...
   * [Adobe Connect集成](authors/feature-summary/adobeconnect-integration.md)
...
* 学习者 {#learner}
   ...
   * [适用于Salesforce的Learning Manager应用程序](learners/feature-summary/sfdc-app.md)
   * [Adobe Connect集成](learners/feature-summary/adobeconnect-integration.md)
   * [适用于移动设备和平板电脑的学习者应用程序](learners/feature-summary/ipad-android-tablet-users.md)
   * [Learning Manager中的社交学习](learners/feature-summary/social-learning-web-user.md)
   * [AdobeLearning Manager桌面应用程序](learners/adobe-learning-manager-app-for-desktop.md)
   * [学习者主页](learners/feature-summary/learner-home-page.md)
   * [分享至社交学习](learners/feature-summary/share-to-social.md)
   * [系统要求 | AdobeLearning Manager桌面应用程序](learners/adobe-learning-manager-app-for-desktop/adobe-learning-manager-desktop-app-system-requirements.md)
* 经理 {#manager}
...
* 知识库 {#knowledge-base}
   * [无法登录Learning Manager](kb/unable-log-in-learning-manager.md)
   * [学习摘要不显示当前数据](kb/learning-summary-not-display-data.md)
   * [无法上传CSV](kb/unable-to-upload-csv.md)
   * [生成HAR文件](kb/generate-har-file.md)
   * [不显示L1反馈自动弹窗](kb/l1-feedback-auto-popup-does-not-appear.md)
   ...
   * [学习管理器中的会话过期](kb/login-issue.md)
   * [无法搜索课程](kb/unable-to-search-course.md)
   * [解决迁移问题](kb/troubleshooting-migration.md)
   * [Learning Manager应用程序问题故障诊断](kb/troubleshooting-issues-with-adobe-learning-manager-desktop-app.md)
   * [Learning Manager中的用户被自动删除](kb/auto-delete.md)
   * [欧盟域的发布问题](kb/publish-issue-eu-domain.md)
   * [无法注册为外部用户](kb/register-issue-external-user.md)
   * [Okta Active Directory与AdobeLearning Manager集成](kb/okta-active-directory-integration.md)
   ...
   * [无法在Learning Manager中查看文件提交](kb/unable-to-view-submitted-file.md)
