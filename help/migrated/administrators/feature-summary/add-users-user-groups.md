...
您还可以删除用户的“作者”或“管理员”访问权限。选择一个或多个学习者，单击&#x200B;**[!UICONTROL “操作”]**，然后选择&#x200B;**[!UICONTROL “删除角色”]**。选择一个选项，例如， **[!UICONTROL 删除作者]**，该学习者的作者访问权限将被撤销。
...
管理员可以通过访问管理员应用程序>用户>用户组&#x200B;]**并单击组名称来**[!UICONTROL &#x200B;执行此作。 **** ****
...
您还可以让公司中的员工自行注册为 Adobe Learning Manager 帐户的学习者，而无需获得您以管理员身份提供的帮助。管理员可以创建自助注册链接并与员工共享，员工可以使用其 Adobe 凭据进一步注册到学习管理器。

在页面右上角，单击“添加&#x200B;]**”**[!UICONTROL ，然后选择“自助注册&#x200B;]**”。**[!UICONTROL 
...
* **非活动状态** - 在此状态下，外部用户的注册将过期。 在通过添加用户工作流程添加外部用户时，管理员为外部用户设置到期日。
...
选择一个用户，然后从右上角单击“作&#x200B;]**”**[!UICONTROL >**[!UICONTROL “删除用户]**”。
...
1. 单击&#x200B;**[!UICONTROL 活动字段中]**>**[!UICONTROL 的用户]**。
1. 启用&#x200B;**[!UICONTROL “限制选择”]**&#x200B;选项。
1. 单击&#x200B;**[!UICONTROL “完成”]**。

+++

+++如何区分 CSV 活动字段和自定义活动字段？
