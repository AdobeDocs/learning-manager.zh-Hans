...
1. 输入实例的属性：
   ...
   * **[!UICONTROL 时区]：** 搜索并从下拉列表中选择 **[!UICONTROL 时区]** 。
...
1. 在实例上，选择下拉菜单，然后选择弃用实例&#x200B;]**选项**[!UICONTROL 。
...
1. **[!UICONTROL 在“实例]**”页面上，选择任意实例上的选项，然后单击“向已注册的学员&#x200B;]**发送电子邮件”。**[!UICONTROL 
...
1. 单击&#x200B;**[!UICONTROL “保存”]**&#x200B;后，您将看到公告已成功创建的确认消息。 如需发布公告，请单击&#x200B;**[!UICONTROL “立即发布”]**。
   ...
   ![已成功创建公告](assets/announcement-successful.png)
...
您也可以将学习者列表导出到 Excel 表格中。 要导出学员列表，请单击“ [!UICONTROL **作**] > [!UICONTROL **导出**]”。

>[!NOTE]
>
>如果一门课程存在多个实例，则每个选项卡中会单独提供 Excel 中的学员列表。 学习者列表包括学习者姓名、状态和选择条件。 学习者状态可以是“**未开始”、“****进行中**”或&#x200B;**“已完成**”。
...
要从“管理员”部分下载报告，请执行以下作：

1. 以管理员&#x200B;]**身份**[!UICONTROL &#x200B;登录。
2. 转到“ **[!UICONTROL 课程]** ”部分并选择必修课程。
3. **[!UICONTROL 在课程概述]**&#x200B;页面中选择&#x200B;**[!UICONTROL 轮候表]**&#x200B;选项。
...
如果由于某种原因，这两个必填问题没有任何文本，则这些问题将不会显示在反馈表单中。
...
在当前版本的 Adobe Learning Manager 中，管理员可就“学习计划”囊括的所有课程发送 L1 反馈。管理员必须确保在课程实例级别为所有课程启用 L1 反馈。

1. 要为每个课程启用 L1 反馈，请在管理员应用程序中单击“学习计划&#x200B;]**”>**[!UICONTROL “**[!UICONTROL 查看学习计划]**”。

1. ]**单击**[!UICONTROL &#x200B;已启用 L1 反馈&#x200B;]**>**[!UICONTROL &#x200B;实例。
...
如果课程以多种语言提供，则测试报告也会以不同的语言显示数据。 到目前为止，无论尝试使用哪种语言进行测验，管理员生成的报告都会一个接一个地显示响应。 **例如**，如果用户参加了荷兰语测验，则管理员一次只能查看用户尝试的荷兰语测验报告。 将英语作为界面语言的管理员无法同时查看所有用户的报告，与参与的区域无关。
...
要启用 L1 反馈，请在管理员应用程序中单击“设置&#x200B;]**”**[!UICONTROL >**[!UICONTROL “反馈]**”。

![](assets/l1-feedback-settings.png)

*查看“反馈设置”页面*

单击右上角的“编辑&#x200B;]**”，然后**[!UICONTROL &#x200B;切换选项以启用 L1 反馈。

作者创建课程后，在管理员应用程序的实例页面上， **[!UICONTROL 会自动为新课程启用 L1 反馈]** 。

<!--![](assets/l1-feedback-enabled.png)-->

您还可以通过切换 **[!UICONTROL “启用]** ”选项来禁用 L1 反馈，如下所示：
...
讨论区功能允许学习者查看课程讨论。 作为管理员，您可以根据需要删除任何注释。 管理员可以在课程设置下启用此选项。
...
**[!UICONTROL 在核对清单]**&#x200B;页面上，讲师可以从作&#x200B;]**下拉列表中导出核对清单报告**[!UICONTROL 。
...
这些注释将显示在 [学习者成绩单](/help/migrated/administrators/feature-summary/reports.md#learner-transcripts) 报告中。
...
通过评估课程效果来了解课程对于学习者是否有帮助。它结合了学员对课程内容提出的反馈、学员的课程测试结果以及经理根据学员对课程的学习情况给予的评估反馈。
...
在&#x200B;**[!UICONTROL “注册学习者”]**&#x200B;对话框中，展开&#x200B;**[!UICONTROL “高级选项”]**&#x200B;选项。 在“ **[!UICONTROL 附加注释]** ”字段中，输入所需的注释。
...
搜索后会显示所有实例中的学习者或用户组。对于每个学习者，学习者注册的实例会显示在“实例&#x200B;]**”列中**[!UICONTROL 。
...
此外，您还可以使用搜索结果选择学习者或用户组，然后执行以下作：
...
1. 单击左侧导航面板中的“学习中的课程&#x200B;]**”**[!UICONTROL &#x200B;部分。
