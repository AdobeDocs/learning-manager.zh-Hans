...
1. 选择&#x200B;**[!UICONTROL 创建角色]**。 将打开&#x200B;**[!UICONTROL 创建新角色]**&#x200B;选项卡。

   ![](assets/create-new-role.png)

   *创建自定义角色*

1. 在&#x200B;**[!UICONTROL 角色名称]**&#x200B;字段中输入名称。
1. **[!UICONTROL 帐户权限]**：这些权限授予角色所有者访问特定系统配置方面的权限，这些权限作用于整个帐户。 选择访问权限。 用户可完全掌控所分配的权限。
...
1. **功能权限 — 核心功能**：用于授予特定功能的访问权限，以便管理学习活动。 可以使用此选项授予对以下功能的权限。
...
1. **功能权限 — 学习对象：**&#x200B;使用此选项可访问学习对象相关功能。 您可以通过访问以下学习对象。
...
1. **功能权限范围：**&#x200B;分配给此角色的功能权限范围可以限制为特定的用户组或一个或多个目录。
