...
**主页体验：** 启用以下任一选项 **Classic** 或 **沉浸式**. 如果选择“沉浸式”，则会显示以下选项：

* **培训类型：** 选择以下任一选项 **行业** 或 **自定对齐**. 自定义培训是在内部创建的。 业界公认的培训包括第三方提供商提供的现成内容。
 ...
 <tbody>
  ...
  <tr>
   <td>
    <p>“推荐作用域设置”<br></p></td>
   <td>
    <p>选择一或多个活动字段。 对于“<b>自定义</b>”，您至多可以选择一个活动字段。 为了 <b>业界公认</b>，您至多可以选择五个活动字段。<br></p></td>
  </tr>
  <tr>
   <td>
