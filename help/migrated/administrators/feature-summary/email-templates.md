...
1. 要访问模板，请单击 **[!UICONTROL 左侧窗格中的电子邮件模板]** 。 在此页面上，您可以看到三种不同类别的模板：“常规”、“学习活动&#x200B;]**”以及**[!UICONTROL “提醒和更新&#x200B;]**”。******[!UICONTROL &#x200B;还有第四个选项卡“设置&#x200B;]**”**[!UICONTROL ，您可以在其中配置模板。
...
1. 如需自定义学习者用来接收电子邮件的名称和电子邮件 ID，请编辑 **[!UICONTROL 发件人姓名和地址]。**

   请联系 [***Adobe 支持部门***](https://helpx.adobe.com/contact/enterprise-support.other.html#learning-manager) 以配置或更改这些详细信息。

1. 从“电子邮件横幅&#x200B;]**”选项自定义**[!UICONTROL &#x200B;电子邮件横幅。通过选择横幅背景&#x200B;]**更改**[!UICONTROL &#x200B;横幅的颜色。

   您可以通过选择“自定义图像” **[!UICONTROL 选项将自定义图像]** 用作横幅。 完成更改后单击&#x200B;**[!UICONTROL 保存]**。
...
1. 通过单击“帐户 URL ]**”选项**[!UICONTROL &#x200B;上的“编辑”来编辑您的帐户 URL。
...
1. 使用可选经理电子邮件&#x200B;]**选项下的**[!UICONTROL &#x200B;复选框，配置经理是否还必须接收发送给其直接下属的电子邮件。
...
在下拉列表中，选择 **[!UICONTROL 每两周一次]** 或 **[!UICONTROL 每月]**&#x200B;一次。

* **[!UICONTROL 每两周一次]：** 如果您将频率设置为 **[!UICONTROL 每两周一次]**，学习者会每两周收到一次电子邮件。
...
启用此选项后，默认情况下，现有/新活动帐户的频率设置为 **[!UICONTROL 每两周一次]** 。
...
如需自定义学习者用来接收通知的电子邮件域和电子邮件 ID，请联系 [***学习管理中心支持***](https://helpx.adobe.com/contact/enterprise-support.other.html#learning-manager) 并提供您要添加的域的详细信息以及您的新电子邮件 ID。
...
您可以使用“**[!UICONTROL 设置]**”选项卡下的“**[!UICONTROL 请勿打扰]**”选项来执行此作。可以使用用户的名称、电子邮件 ID 或唯一用户 ID 将用户添加到此列表。
...
* **直接向学习者发送电子邮件：** 此选项限制或允许发送给学习者的电子邮件。
...
您可以使用 CSV 将用户添加到 DND 列表。 为以下每个列包括真/假/空白值：
...
* 编辑电子邮件页脚。 页脚区域包含帐户 URL、签名和用户添加的任何自由格式文本的预定义变量。
...
## 内嵌邀请 {#inlineinvitations}

学习管理器用户现在将收到内联电子邮件邀请。 ICS 附件不再用于发送邀请。 邀请中的任何更改都将自动反映在您的日历中。
