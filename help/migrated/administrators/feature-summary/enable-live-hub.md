...
1. 在左侧导览窗格中选择“学习中&#x200B;**”的** AI。
   ...
   ![学习导航中的AI](assets/ai-in-learning-nav.png)
   *选择“学习中的AI”以启用Live Hub。*

1. 选择&#x200B;**实时中心**。<br> 将打开&#x200B;**实时中心**&#x200B;页面。

   ![实时中心设置页面](assets/live-hub-settings-page.png)
   *实时中心设置显示了在ALM中启用实时中心的选项。*

1. 切换&#x200B;**为此帐户启用实时中心**。<br> 此时会显示&#x200B;**将Live Hub设置为默认**&#x200B;对话框。

   ![设置实时中心默认对话框](assets/set-live-hub-default-dialog.png)
   *在弹出窗口中选择“设置为默认值”。*
...
1. 在Live Hub **中打开** AI，以便在实时会话中提供AI支持的助理。
   ...
   ![在实时中心中启用Ai](assets/enable-ai-in-live-hub.png)
