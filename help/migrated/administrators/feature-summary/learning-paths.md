...
管理员通常希望能够构建详细的课程表，以帮助他人深入了解特定主题或专业领域。 该课程表也可以是员工或客户需要完成的一系列培训课程。 为此，需要将一组课程和计划相结合，形成完整的培训包。
...
1. 能够向新学习路径中嵌入现有学习路径。 嵌入功能仅适用于 1 级嵌入。 因此，已包含嵌入路径的学习路径无法嵌入到新路径中。
1. 能够在学习路径级别添加先决条件、工作辅助和资源。
1. 能够创建章节。 每个章节均有一个标题。
1. 能够将章节设为必修并设置完成标准。

## 在 Adobe Learning Manager 中添加学习路径
...
您可以添加技能并为“学习路径”分配徽章。 要添加技能，可在&#x200B;**[!UICONTROL “挑选技能”]**&#x200B;下拉列表中选择所需技能。 然后选择一项或多项技能的级别。
...
**重新排列顺序**：您可以上下移动课程，更改其顺序。

![](assets/rearrange.png)

*重新排列培训顺序*

**删除课程：**&#x200B;在课程卡上，单击 X，然后从“学习路径”中删除该课程。
...
学习者可以继续使用“学习计划”（现在称为“学习路径”），作者/管理员也可以继续创建学习计划（或学习路径）。 为利用上述学习路径的扩展功能，管理员应启用以下设置。 启用后，“学习路径”的所有新扩展功能均可使用。
