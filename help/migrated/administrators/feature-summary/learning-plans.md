...
**3 — 从组中删除学习者：** 从组中删除用户或学习者时触发事件。 输入并选择此事件适用的用户组自下拉列表。 您可以选择多个组。

![](assets/learner-removed-from-group.png)


**4 — 学习者完成课程/学习路径/认证：** 当学习者完成任何学习对象（如课程、学习计划等）时，会触发此事件。 选择此事件适用的学习对象。选择事件的完成状态。或者，您也可以选择此学习者所属的用户组。完成学习对象后，输入天数，即可触发此事件。如果要将此事件分配给已完成此学习对象的现有用户，请选择此选项。

![](assets/learner-completealearningobject.png)

**5 — 学习者未能通过课程模块：** 如果学习者未能通过任何学习对象（如课程、学习计划等），则会触发此事件。 选择此事件适用的学习对象。您还可以选择此学习者所属的用户组。
...
创建学习计划后，管理员可以随时编辑/更新学习计划。要编辑，请选择学习计划的名称，然后修改 **[!UICONTROL 编辑学习计划]** 此时会显示弹出对话框。  选择&#x200B;**[!UICONTROL “保存”]**。

>[!NOTE]
>
>您无法修改 **[!UICONTROL 发生于]** 选项中的 **[!UICONTROL 编辑学习计划]** 弹出窗口。
