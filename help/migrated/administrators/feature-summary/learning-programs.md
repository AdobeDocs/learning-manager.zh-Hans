...
1. 选择注册类型为“管理员注册”或“自助注册”，具体视您的选择而定。 选中“取消注册”选项和“课程排序”选项，然后单击“保存”。 如果您选择自助注册，学习者可以自行注册学习计划。
   ...
   **注意**
   ...
   所有类型的课程都可以添加到学习计划中， 其中包括教室和虚拟教室课程、活动、自学和混合课程。 在学习计划中的课程选择过程中，未显示经理指派和经理批准的课程。
...
1. 单击左侧窗格顶部的&#x200B;**[!UICONTROL 返回计划]**，可以查看所有学习计划的列表。 新添加的学习计划也在此处列出。
...
管理员可以在学习计划中添加教室和虚拟教室类型的课程。 作者在课程创建期间所提供的任何会话，都将成为默认实例。 当管理员向学习计划中添加课程时，默认情况下该课程将映射到所有课程的默认实例，但是管理员可以更改实例映射。 在实例页面中也可以看到添加到学习计划中的课程计数，如下所示。
...
通过使用灵活学习计划，学习者可以参加不受默认实例限制的培训。 管理员可创建不同实例，以满足学习者的需求。 此类学习计划通常以教室或虚拟教室课堂展开。 为确保所有学习者都有机会参加学习计划，管理员可以根据不同时区创建多个课程实例。
...
管理员可以为学习计划启用 L1 和 L3 反馈。 学习者提供的 L1 反馈将显示在 L1 反馈选项卡下，管理员提供的 L3 反馈将显示在 L3 反馈选项卡下。
...
要编辑已发布的学习计划，请单击学习计划卡，然后单击页面右上角的&#x200B;**[!UICONTROL 编辑]**。
