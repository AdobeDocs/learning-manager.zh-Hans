...
多次注册功能可通过各种可用实例将学习者多次注册到一门课程中。  无论学习者是处于已注册、已完成还是尚未开始的状态，学习者都可以注册多个课程实例。 当作者启用[!UICONTROL 多次注册]功能切换按钮后，学习者可以注册课程的多个实例。
...
1. 以作者身份登录您的 Adobe Learning Manager 帐户。
1. 选择您希望学习者多次注册的课程。
...
对于注册同一课程的两个实例的学习者，系统将为每个课程实例创建两行。 该报告还会显示实例的进度。
