...
报告会汇总到信息板。 报告必须位于信息板中。 默认情况下，**[!UICONTROL “默认信息板”]**&#x200B;位于报告页面中。 您添加的任何报告都会移动到此默认信息板。 若要将报告添加到各个信息板，请使用下拉箭头并选择&#x200B;**[!UICONTROL “添加报告”]**。 有关创建信息板的更多信息，请参阅本页上的“信息板”部分。

## 报告类型 {#typesofreports}

Adobe Learning Manager 支持四种主要类型的报告，例如完成、花费的时间、技能和效果。 您可以使用以下报告类型生成 300 多种不同报告：
...
>[!INFO]
>
>在本培训中，您将了解如何从数据库生成仪表板报告。<br><br>[![按钮](assets/launch-training-button.png)](https://content.adobelearningmanageracademy.com/app/learner?accountId=98632#/course/8318854)</br></br>


如果您无法启动培训，请写入<almacademy@adobe.com>。

查看平台中所有学习活动的摘要报告。 在此页面上，您可以看到所选root用户的团队和外部配置文件的以下摘要信息。 您还可以选择时间范围：
...
所有外部个人资料将列在内部个人资料（内部根级别用户）之后。

如果外部个人资料设有相应的经理，则经理层级将在&#x200B;**[!UICONTROL “显示以下对象的数据”]**&#x200B;下拉列表中显示。 用户将在所有详细信息页面（学习摘要、合规性和技能状态）的经理层次结构中列出

否则，列表中将显示所有个人用户的详细信息。

要查看有关各内部团队注册的更详尽的信息，请单击&#x200B;**[!UICONTROL “学习摘要详细信息”]**。

![](assets/learning-sunnarydetails.png)
*学习摘要详细信息*

单击任何注册时，您都可看到每个经理的学员以及他们注册的学习对象。 您还可查看每个学习者的进度及具体完成情况。
...
此外，您还可查看正在学习以及已习得的技能的条形图视图。 您可以添加/删除要在图表中显示的技能。
...
信息板为报告合集。 报告可根据您的选择分组为信息板。 要查看您创建的所有讨论区，请单击此讨论区选项卡。 在&#x200B;**[!UICONTROL “视图信息板”]**&#x200B;下拉列表中，您可以选择默认讨论区或您创建的信息板。
...
1. 打开&#x200B;**[!UICONTROL 报告]** > **[!UICONTROL 自定义报告]** > **[!UICONTROL Excel报告]** > **[!UICONTROL 公告报告]**。 此时会打开&#x200B;**[!UICONTROL “生成报告请求”]**&#x200B;对话框。 单击“确定”。
...
使用&#x200B;**[!UICONTROL “内容审查追踪”]**&#x200B;报告生成器生成报告，其中记录了课程在其系统周期中所进行的所有更改和编辑。 生成的报告提取了以下信息。
...
用户审查追踪功能可捕获用户、用户组和自注册配置文件的生命周期。 它还可捕获用户增加、删除和经理变更等内容。 此外，还记录自注册配置文件的创建和删除。 还可以暂停和恢复自注册。

可添加、启用、禁用、暂停或恢复外部配置文件；可添加、删除、暂停或恢复自注册。 还会捕捉 CSV 上传。

1. 选择&#x200B;**[!UICONTROL 报告> Excel报告>用户轨迹]**。 此时会显示用户审查追踪对话框。
...
1. 单击“**[!UICONTROL 生成]**”以生成报告。
   ...
   * 白金级获得日期
   ...
   这些列包含首次获得该级别的日期。 **[!UICONTROL 当前级别]**&#x200B;列显示了学习者的当前级别。
...
管理员和经理可以提取报告，了解已注册和已取消注册的学习者。 管理员可查看已注册或已取消注册课程、学习计划或认证的实例的任何学习者、管理员或经理，并导出报告。 而经理只能提取团队成员的报告。 经理无法在经理应用程序中将已删除的学习者或其自己的姓名视为已注册或已取消注册的学习者。
...
Adobe Learning Manager 支持培训报告功能，管理员可以通过该功能下载培训详细信息及其关联的元数据，如作者、发布日期、技能、目录标签等。
...
选择过滤器并单击“下载”后，您将收到以 CSV 格式下载报告的通知。
...
>[!INFO]
>
>在本培训中，您将了解如何为仪表板报表设置电子邮件订阅。<br><br>[![按钮](assets/launch-training-button.png)](https://content.adobelearningmanageracademy.com/app/learner?accountId=98632#/course/8318927)</br></br>
...
要从下拉列表中选择报告名称，请开始在“报告”字段中输入报告名称。 从下拉列表中选择电子邮件的频率。 您可以添加电子邮件的主题并提供备用电子邮件 ID。
...
1. 要开始创建自己的讨论区，单击页面右侧的“添加信息板”。

   ![](assets/add-dashboards.png)
   *添加仪表板*

1. 提供信息板的名称和描述。
1. 如果想要与经理共享信息板，请在&#x200B;**[!UICONTROL “共享对象”]**&#x200B;字段中进行选择。 您可以使用任何正常选择标准进行此操作。
1. 单击&#x200B;**[!UICONTROL 保存]。**

您可以在&#x200B;**[!UICONTROL “信息板报告”]**&#x200B;选项卡中查看最近创建的讨论区。

若要将报告添加到讨论区，请单击讨论区窗口右上角的下拉列表，然后单击&#x200B;**[!UICONTROL “添加报告”]**。 以这种方式创建的报告会与信息板关联。
...
* 在&#x200B;**[!UICONTROL “共享对象”]**&#x200B;字段中输入信息板的共享用户。
...
在x轴中，选择用户属性选项，然后从属性旁边的&#x200B;**选择**&#x200B;下拉列表中选择属性。 若要创建基于这些属性的自定义用户组报告，您还须在过滤器中选择相应的用户组。
...
1. 单击“报告”页面上的“我的信息板”选项卡中的&#x200B;**[!UICONTROL “查看课程报告”]**&#x200B;链接。\
...
**[!UICONTROL 移动至信息板：]**&#x200B;您可以将当前报告移动至从信息板列表中选择的其他信息板。

**[!UICONTROL 创建副本：]**&#x200B;您可以将报告复制到同一信息板或从信息板列表中选择的其他信息板。

**[!UICONTROL 删除：]**&#x200B;单击“删除”以移除报告。 在您删除报告前，会显示警告/确认消息。

**[!UICONTROL 调整大小]**&#x200B;您可以将报告的大小调整为 1×1（中等）和 2×2（大）。
