...
您可以更改管理员个人资料设置并更新自己的帐户设置。 查看自己的个人信息，添加/更改头像照片并修改&#x200B;**[!UICONTROL “关于我”]**&#x200B;的内容。 更新公司信息，为用户设置登录方法，并通过帐户设置来设置连接集成。
...
如果要添加或更改公司支持管理员的电子邮件地址，可以单击左侧窗格中的&#x200B;**[!UICONTROL 常规]**&#x200B;进行配置。 单击&#x200B;**[!UICONTROL 支持电子邮件 ID]** 旁边的&#x200B;**[!UICONTROL 更改]**&#x200B;并添加电子邮件 ID。 学习者单击该页面页脚的&#x200B;**[!UICONTROL 联系管理员]**&#x200B;时，系统会向管理员发送电子邮件。
...
单击左侧窗格中的&#x200B;**[!UICONTROL 常规]**，然后选择“课程审阅”选项以启用“课程审阅”功能。 要了解有关此功能的更多信息，请参阅[课程审阅](courses.md#main-pars_header_1879001177)。
...
在左侧窗格中单击 **[!UICONTROL Adobe Connect]**，配置 Adobe Connect 帐户以主持虚拟教室会话。 有关详细信息，请参阅[Adobe Connect](adobeconnect-integration.md)功能帮助。
...
<table>
 <tbody>
  ...
  <tr>
   <td>显示课程效果</td>
   <td>如果启用，学习者可以在课程磁贴上查看当前的课程效果。 此功能仅适用于课程。 学习计划或证书不支持星级评分。 适用于课程和学习计划，但不适用于认证。</td>
  </tr>
  <tr>
   <td>课程审阅</td>
  ...
  <tr>
   <td>技能/标签可视性</td>
   <td>向学习者显示所有技能和标签。 您可以显示所有技能和标签，也可以显示已分配的技能和标签，或者是学习者可见目录部分中的技能和标签。
   <p><b>重要学习者助理和目录可见性</b></p>
   <p>如果您的帐户使用“学习者助理”，请记住，选为“助理”内容源的目录范围不取决于每个学习者目录可见性。 即使某些培训在目录视图中对于给定学习者不可见，助理也可以使用已配置目录中的内容。</p>
   <p>Adobe建议仅选择那些包含可以轻松向有权访问学习者助理的所有学习者公开（以摘要或说明的形式列出）的内容的目录。 </p>
   </td>
  ...
  <tr>
   <td height="20">自动删除已清除的用户</td>
   <td>如果启用，当内部用户在指定的天数内未访问系统时，则会被自动删除。 此功能适用于仅具有“学习者”角色的用户。 要恢复访问权限，用户必须与管理员联系。 启用该选项后，您可以指定在几年后从ALM中永久删除已清除用户的时间。</td>
  </tr>
  <tr>
  <tr>
   <td>显示目录标签</td>
   <td>如果启用，管理员和作者可以设置目录标签和值，并将它们链接到学习对象。 选择此选项后，作者还可以在目录中添加课程、学习路径、认证或工作辅助。</td>
  </tr>
  <tr>
   <td>学习者可以查看自己的成绩</td>
  ...
  <tr>
   ...
   <td>
    ...
    <p>使用作业 API 下载的学习者成绩单还可以下载选定时区中的数据。</p>
...
<table border="0" cellpadding="0" cellspacing="0" width="1709">
 <tbody>
  ...
  <tr>
   <td height="20">注意：默认情况下，“格式”和“持续时间”过滤器为关闭状态，发布后不会立即向学习者显示。 管理员应启用这些过滤器。 </td>
  </tr>
  <tr>
   <td height="20">显示目录列表</td>
   <td>如果启用，学习者可以看到他们可用的所有目录的列表。 学习者可以使用它来优化学习对象的显示方式。
   <p><b>重要学习者助理和目录可见性</b></p>
   <p>如果您的帐户使用“学习者助理”，请记住，选为“助理”内容源的目录范围不取决于每个学习者目录可见性。 即使某些培训在目录视图中对于给定学习者不可见，助理也可以使用已配置目录中的内容。</p>
   <p>Adobe建议仅选择那些包含可以轻松向有权访问学习者助理的所有学习者公开（以摘要或说明的形式列出）的内容的目录。 </p>
   </td>
  ...
  <tr>
   <td height="19">对于试用帐户，摘要电子邮件选项将保持禁用状态，且管理员亦无法启用该选项。</td>
  </tr>
  <tr>
   <td height="19">若已禁用该功能，则：</td>
  </tr>
  <tr>
   <td height="19">“摘要电子邮件”选项将失效。</td>
  </tr>
  <tr>
   <td height="19">学习者无法查看摘要电子邮件订阅的用户设置。</td>
  </tr>
  <tr>
   <td height="19"> 若已启用该功能，则：</td>
  </tr>
  <tr>
   <td height="19">管理员可以启用及修改摘要电子邮件选项。</td>
  </tr>
  <tr>
   <td height="20">在“学习者”应用的“个人资料设置”中，学习者（不在 DND 列表中）可以选择订阅/退订摘要电子邮件。</td>
  </tr>
  <tr>
  ...
  <tr>
   <td height="19">2. 要跨所有区域设置级联更改，请单击“复制”。 这样可确保所有语言都获得此名称和 URL。</td>
  </tr>
  <tr>
  ...
  <tr>
   <td height="20">自定义所有语言页脚上的链接。 单击“语言”下拉列表，选择语言，并在指定的字段添加“名称”和“URL”。 保存更改后，页脚上将显示更新的链接。</td>
  </tr>
  <tr>
  ...
  <tr>
   <td height="19">使用作业 API 下载的学习者成绩单还可以下载选定时区中的数据。</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>
    ...
    <p>对于现有帐户，如果帐户以前启用了<b>“课程效果”</b>选项，则将启用<b>“显示评级”</b>部分，并选择“课程效果”选项。 如果禁用<b>“课程效果”</b>选项，则<b>“显示评级”</b>部分也将禁用。 启用<b>“显示评级”</b>部分后，默认情况下将启用<b>“星级评分”</b>选项。</p></td>
  </tr>
  <tr>
   <td height="19">弃用</td>
...
<table>
 <tbody>
  ...
  <tr>
    ...
    <td>
      <p>学习者完成课程/路径后，可以通过备用方法将另一组指定的课程/路径标记为已完成。 学习者将不会通过替代自动注册标记为完成的课程/路径，并且只会收到实际完成的课程/路径的积分、徽章和点数。 可用选项包括：激活追溯完成和激活追溯不完成。
      </p>
    </td>
  </tr>
  </tr>
...
1. 在弹出对话框中，将鼠标悬停在头像上并单击头像区域的&#x200B;**[!UICONTROL “编辑”]**&#x200B;即可添加/更改图片。
1. 单击头像旁边的&#x200B;**[!UICONTROL “编辑”]**&#x200B;来添加/修改&#x200B;**[!UICONTROL “关于”]**&#x200B;内容。
1. 单击&#x200B;**[!UICONTROL 保存]。**

## 内容文件夹 {#content-folder}

Adobe Learning Manager 支持私密内容文件夹。 管理员可以配置私密内容文件夹，并使用“自定义角色”为特定自定义作者提供访问权限。 请注意，标准作者（也称为“拥有完整权限的作者”）仍有权访问帐户中的所有内容。 也即，拥有完整权限的作者有权访问所有文件夹和所有内容。
...
* 只有管理员才能创建、编辑或删除文件夹。
* 根据仅限自定义管理员的角色定义，管理员能够控制文件夹访问权限。
...
您也可删除文件夹。 选择要删除的文件夹，单击“操作”菜单，然后单击&#x200B;**[!UICONTROL “删除文件夹”]**。

>[!NOTE]
>
>当文件夹的所有关联内容也与其他文件夹关联时，可以删除这些文件夹。 如果存在与要被删除的文件夹关联的内容，请先将此内容移至另一个文件夹，然后再删除该文件夹。
...
在“**[!UICONTROL 设置]**”>“**[!UICONTROL 基本信息]**”中，单击“**[!UICONTROL 更改]**”。 从下拉列表的&#x200B;**[!UICONTROL 财务年度开始日期]**&#x200B;中，选择月份。
+++
