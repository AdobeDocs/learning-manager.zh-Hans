...
1. 为技能分配域。 创建技能时，您可将其与 Adobe Learning Manager 所支持的最相关技能域进行映射。 有关更多信息，请参阅&#x200B;[***映射域到技能***](/help/migrated/administrators/feature-summary/curation-skills.md)。
...
管理员可以使用&#x200B;**添加技能**&#x200B;对话框中的批量上传选项，直接在Adobe Learning Manager中添加多个技能。

批量添加技能：

1. 从左侧窗格中选择&#x200B;**技能**。

1. 选择“**添加**”>“**添加技能**”。<br> 此时会弹出窗口&#x200B;**添加技能**。

1. 选择&#x200B;**批量添加技能（上传CSV）**。

   ![使用“上传CSV”选项批量添加技能对话框](assets/add-skills-bulk-upload-csv.png)
   *添加技能弹出窗口，其中显示了批量添加技能的选项。*
...
在&#x200B;**[!UICONTROL “技能”]**&#x200B;页面上，单击需要修改的技能。 在&#x200B;**[!UICONTROL “编辑技能”]**&#x200B;对话框中，进行必要的更改，例如，
...
1. 上传 CSV。 CSV 中的列包括：
   ...
   * 讲师电子邮件或讲师 UUID
   ...
   对于启用了 UUID 的帐户，请将“讲师电子邮件”列替换为“讲师 UUID”。
...
* [技能和 Adobe Learning Manager](https://elearning.adobe.com/2018/11/skills-captivate-prime/)