...
+++在为学习者创建登录时，如果输入的电子邮件 ID 有误，该如何更正？
...
[Adobe Learning Manager 示例 CSV.csv](https://helpx.adobe.com/content/dam/help/en/captivate_prime/learning-manager-sample-csv.zip)
...
Adobe Learning Manager 不提供课程证书。 但是，管理员可以单击左侧窗格中的“徽章”选项卡，为每门课程创建徽章。 当管理员将学习者注册到课程时，还可以将徽章与课程相关联。
...
Adobe Learning Manager 1.0 版本中没有任何设置课程日历的规定。
...
是的，您可以根据公司要求更改 Adobe Learning Manager 应用程序的主题和品牌推广。 系统中提供一组五个代表性图像，用于在将颜色主题更改应用到应用程序之前对其进行预览。 单击图像左右两侧的“&lt;“和”>”符号可以浏览并预览这些图像。
...
有关更多信息，请参阅[帐单管理](/help/migrated/administrators/feature-summary/billing-management.md)功能。

+++

+++能否自定义证书设计？ 该如何操作？

在 Adobe Learning Manager 中，您可以通过颁发徽章来识别学习者。 有关更多信息，请参阅徽章功能。  另请参阅认证功能。
...
联系 Adobe Learning Manager 支持团队。

+++

+++可于何处找到自己的 Adobe Learning Manager 帐户 ID？
...
+++是否有我可以提取的报告，或者有人可以为我提取的报告，该报告会向我显示LMS中所有课程的列表？
