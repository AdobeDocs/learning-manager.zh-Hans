...
利用Content Composer，您可以在创作过程中将课程分发给审阅者和学习者，并与团队进行协作，所有这些操作都无需离开工具。
在发布之前，您可以将课程发送给审阅者以获取反馈。 审阅者可以在其浏览器中打开项目、发表评论、提出更改建议并标记其他协作者以供输入，而无需安装Content Composer。 您可以根据需要，处理反馈、更新课程并启动其他审核周期。
