 ...
 <tbody>
  ...
  <tr>
   ...
   <ul>
      ...
      <li>设计评估，以便简单地改变学习材料的措辞，而不会轻易地显示正确的答案。</li>
   </ul>
...
6. 选择[!UICONTROL “保存”]。 系统开始生成和转换VTT文件。
...
* 通知：当VTT生成和转换完成时，作者会收到通知。
* 编辑灵活性：可以在应用程序内编辑字幕，也可以离线编辑并重新上传。
* 可扩展性：专为企业级本地化和辅助功能需求而设计。
* 无需手动VTT上传：系统可使用上传的视频/音频从头开始生成VTT文件。
