...
1. **修改课程设置**-
   ...
   * **经理批准：**&#x200B;需要经理批准此类课程。学习者可以注册这些课程，但未经经理批准，他们不能直接注册这些类型的课程。 学习者申请注册此类课程时，经理会收到通知请求。经理批准后，此类课程才会显示已被学习者注册。
   * **自助注册：**&#x200B;学习者可直接自行注册此类课程。

1. 要保存更改，请单击&#x200B;**[!UICONTROL “保存”]**。要发布课程，请单击发布&#x200B;****。
...
1. **修改课程设置**-
   ...
   1. 在“课程设置”页面，选择该课程的技能。 从“技能”下拉列表中，选择所需的技能。 然后，从“级别”下拉列表中，选择所需的级别。
   1. 选择课程技能、级别并设置技能的积分。如有需要，添加更多技能。
   1. 根据需要，向课程添加自定义合规性标签。 请参阅 [向课程/学习路径/认证](/help/migrated/authors/feature-summary/courses.md#add-compliance-labels-to-courselearning-pathcertification)添加合规性标签。
   1. 从&#x200B;**“注册类型”**&#x200B;下拉列表中，选择注册类型。
...
1. 选择为课程设置价格或者将其设置为免费课程。 如果要将课程设置为付费课程，请选择相应选项&#x200B;**[!UICONTROL “付费”]**，然后指定价格。 随后，价格会显示在学习者的课程卡片和课程概述页面上。

   注意：仅在配置 Adobe Commerce 连接器时才会启用此选项。

1. 如果希望学习者能够取消注册您的课程，请选中&#x200B;**“学习者可自行取消注册”**&#x200B;复选框。

1. **实例配置**

   如果启用此选项，处于“进行中”状态的学习者可以访问其他实例并在其中注册。 学习者还可以保留上一个实例的进度。
   ...
   * 混合
   ...
   注意：复制课程时，如果您在源课程中启用了实例配置选项，则该选项在目标课程中保持禁用状态。
...
1. **多个注册**
   ...
   利用这一功能，您可以在一个或多个时间段为学员注册多个课程实例。

   启用“多重注册&#x200B;**”切换开关**，可在学习者的各种课程注册之间切换。如果已启用实例切换，则不能使用多注册。

1. 选择在参加您的课程前必须完成的预修课程。单击“课程”字段并从课程列表中选择。
1. **如果您希望将预修课程设为必修课程，请启用“启用****先决条件”**&#x200B;复选框。
1. 添加关键字作为与您课程相关的标签。这些标签可以帮助学习者在搜索时轻松找到您的课程。所有这些标签根据所添加的模块自动添加。如果要添加其他标签到此课程，可自行添加。
1. 添加关键字作为与您课程相关的标签。这些标签可以帮助学习者在搜索时轻松找到您的课程。所有这些标签根据所添加的模块自动添加。如果要添加其他标签到此课程，可自行添加。
1. 在“自动停用”字段中，选择课程停用的日期。 管理员必须先启用自动弃用选项。
1. 要保存更改，请单击&#x200B;**[!UICONTROL “保存”]**。要发布课程，请单击发布&#x200B;****。

### 向课程/学习路径/认证添加合规性标签 {#add-custom-compliance-label}

若要向课程添加合规性标签，请执行以下步骤：

1. 在作者应用程序中，转到“课程/学习路径&#x200B;]**/**[!UICONTROL &#x200B;认证&#x200B;]**”，然后选择“**[!UICONTROL &#x200B;添加&#x200B;]**”。******[!UICONTROL 
...
1. 在“ **[!UICONTROL 自定义合规性]** ”文本框中，键入并选择合规性标签。
   ...
   >[!IMPORTANT]
   >
   >请确保在添加自定义合规性时为课程设置截止日期。

1. 保存并发布课程/学习路径/认证。现在，课程/学习路径/认证被视为合规性类型。 管理员可以将此课程添加到合规性信息板并与经理共享以跟踪进度
...
您可以在课程和课程实例级别分配游戏点数。 这样，您就可以为不同的课程或实例授予点数。 激励学习者参加特定课程或更喜欢特定课程实例而不是其他课程实例。
...
作为作者，选择“学习路径&#x200B;]**”**[!UICONTROL >**[!UICONTROL “设置]**”。单击“编辑&#x200B;]**”。**[!UICONTROL 

在“资源&#x200B;]**”**[!UICONTROL &#x200B;部分中，复选框“显示按学习路径级别聚合的组成课程资源（启用时）”会显示课程级别的资源是否显示在学习路径级别。

>[!NOTE]
>
>在学习路径的“设置”页面上，管理员也可以启用此选项，该选项会显示课程级别中存在的资源，这些资源将显示在学习路径级别上。

## 计划助手

管理预订讲师和教室中的冲突。 如果您想在将讲师分配到课程之前了解该讲师在什么时间和日期有空，请使用日程安排助理。

创建课程时，对于 VC 或 CR 课程，单击“日程安排助手”。

![选择“日程安排助理”](assets/scheduling-assistant.png)

*启动计划助手*

将启动“日程安排助理”窗口。

![“日程安排助理”屏幕](assets/scheduling-assistant-window.png)
...
![按姓名搜索讲师](assets/search-instructor.png)

*搜索讲师*

您可以选择多名讲师，但一次只能分配一名讲师。选定的时间将在时间冲突窗口中突出显示。 在讲师附近，会显示一个叉形图标，单击该图标可将讲师移除。
...
只能按部分或完整技能名称搜索技能，而不能按技能级别搜索。

在“计划助手”中，输入讲师姓名、位置和名额限制。

此外，您还可以搜索技能，单击讲师搜索框右侧的过滤器图标后会显示该技能。 您可在下方的屏幕截图中看到该按钮。

![输入讲师的技能](assets/scheduling-assistant-instructor-skill.png)

*按技能搜索讲师*

### 用户组过滤器

在讲师字段中选择筛选器。 **[!UICONTROL 用户组]**&#x200B;在过滤作者或自定义作者后，可使用用户组中的值找到相应的讲师。
...
“实例”页面上的管理员和自定义管理员/作者也可以使用计划助手。

![实例页面中的调度助手](assets/instances-scheduling.png)

*从“实例”页面安排讲师*

### 搜索位置

您可以通过在模块和日程安排助理页面上指定教室名称和位置区域名称来搜索位置。

## 富文本格式设置

创建课程、学习计划、认证或工作辅助时，作者可以输入不同类型的内容（如文本、图像），或应用各种文本格式设置选项。

创建课程时，您可以在课程概述字段中看到富文本编辑器。 您可以设置内容的格式、添加图像、添加超链接等。
...
附加的 CSS 样式表包含 Adobe Learning Manager 应用的样式。我们已根据大多数用例对该样式进行调整。 下载附加的 CSS 文件，并按照您的习惯和构建系统将其导入 Web 应用程序。 定义的 CSS 类在 ql-editor 类下命名，它们不会干扰您现有的样式。
...
客户在构建无头界面时，需要在正在开发的自定义用户界面中显示学习对象。 为此，客户通常使用公开的 [GET /learningObjects](https://learningmanagereu.adobe.com/docs/primeapi/v2/#!/learning_object/get_learningObjects) API。 现在，学习管理器支持为概述字段捕获“富文本”，API 响应中学习对象的数据模型也会公开相同的内容。 请参阅下面 API 响应中模型片段中名为“richTextOverview”的字段。 另请注意，为了向后兼容，之前公开的字段（“概述”）保持不变。
 ...
 <tbody>
  ...
  <tr>
   <td>
    <p>设置尝试级别</p></td>
   <td>
    <p>您可以将模块的尝试次数设置为不限次数或指定确切的限制。<span style="font-size: 0.8125rem;">启用后，学习者将可以看到尝试信息。学习者可以通过单击“重新尝试”按钮来选择重新尝试模块。</span></p></td>
  </tr>
  <tr>
   <td>
    <p>模块完成或通过后停止新尝试</p></td>
   <td>
    <p>要配置何时停止学习者选择新尝试选项，请启用“模块完成或通过后停止新尝试”复选框。 成功完成模块后，“重新尝试”选项将从学习者视图中删除。</p></td>
  </tr>
  <tr>
   <td>
    <p>在两次尝试之间锁定模块 0:0:1 格式：天/小时/分钟</p></td>
   <td>
    <p>您可以通过启用“在两次尝试之间锁定模块 0:0:1 格式：天/小时/分钟</b>”<b>复选框，在两次尝试之间的特定时间内锁定模块。模块锁定后，学习者在提供的锁定时间过后才能访问该模块。 </p>
    <p>您可以通过选中“<b>玩家关闭</b>”或<b>“完成</b>”复选框来定义尝试的结束条件。</p></td>
  </tr>
  <tr>
   <td>
    <p>播放器关闭</p></td>
  ...
  <tr>
   <td>
    <p>设置完成模块的时间限制</p></td>
   <td>
    <p>作者可以通过启用“<b>设置完成模块的时间限制”复选框来设置完成模块</b>的时间限制。</p>
...
1. 单击&#x200B;**[!UICONTROL “添加模块”]**。您可以看到四个添加模块的选项。第一个选项是添加自学模块。这些是您创建并添加到 Adobe Learning Manager 模块库的模块。第二个选项是设置虚拟教室。第三个是设置教室模块，第四个是活动模块。
   ...
   *添加 VC 模块*
   ...
   如果为会议组织者选择 **“是** ”，则必须输入组织者的名称。 输入名称，然后选择组织者。
   ...
   *添加教室模块*
   ...
   创建课程时，在虚拟教室配置对话框中，将会议系统设置为您创建的 Microsoft Teams 连接。 选择是否要为事件设置会议组织者。

   如果为会议组织者选择“是”，则必须输入组织者的名称。 输入组织者的名称并选择组织者。

   **大厅旁路**

   * 如果选择“是”，则任何学习者均可加入会议。
   * 如果选择否，系统会向组织者发送请求，以允许或阻止学习者加入会议。

   **注意：** 如果学习者希望以访客身份加入 Microsoft Teams，则必须输入电子邮件地址。 电子邮件必须存在于学习管理器中。
   ...
   *添加活动模块*
   ...
   在课程中为活动类型“文件提交”和基于 xAPI 的模块添加活动模块时，您可以指定持续时间。
...
作者可以在活动模块中添加 HTML 链接并设置完成条件。 若要添加 HTML 链接并设置完成条件，请执行以下步骤：

1. 在作者应用程序中，选择 **[!UICONTROL 主页上的创建课程]** 。
1. 从课程目录&#x200B;]**屏幕中选择**[!UICONTROL &#x200B;添加&#x200B;]****[!UICONTROL 
1. 输入课程的名称和描述。
1. **[!UICONTROL 在“模块]**”选项中，选择“添加模块&#x200B;]**>**[!UICONTROL **[!UICONTROL 活动模块]**”。
1. 在“活动模块&#x200B;]**”提示中**[!UICONTROL ，键入名称和描述。
1. 选择“ **[!UICONTROL 类型]** ”作为 **[!UICONTROL “外部 URL]**”。
1. 从“完成条件&#x200B;]**”选项中选择**[!UICONTROL &#x200B;以下任一选项。
   * **[!UICONTROL 学习者标记完成]**：学习者可以选择在流体播放器中将课程标记为已完成。
   * **[!UICONTROL 启动内容]**&#x200B;时：学习者启动课程时，系统将自动标记为完成。
...
评估对任何学习管理系统来说都很重要。 在线评估是评估学习者对主题理解的最佳方式之一。 但通常，有必要通过观察一个人执行必要的任务来评估一个人在工作中的理解。
...
只有作者才能创建清单。 清单是一种“活动”模块。 设置活动模块时，作者可以选择活动作为核对清单&#x200B;**，**&#x200B;如下所示：
...
此外，如果您有任何要注释或注释的内容，可以在“ **注释到教师** ”文本字段中添加。
...
1. 要重新发布包含更新的课程，请单击重新 **[!UICONTROL 发布]**。

## 观察清单

目前除讲师之外，经理亦可以审核“清单”模块。 管理人员和非层级经理（如商店经理或位置经理）可审核并填写清单。

设置清单模块时，通过在“审阅者”部分中选择这些角色选项，课程作者可以将人员经理和非层级经理（如果适用）添加为审阅者。 此操作可以在课程实例级别中完成。

![经理核对清单](assets/manager-checklist.png)

*在活动模块中添加审阅人*

选择“**[!UICONTROL +经理]**”选项后，组织层次结构中的学习者经理会自动查看核对清单。 您无需逐个搜索和添加经理姓名。

如果您的帐户管理员使用“活动字段”选项设置了非层级经理角色（如位置经理或现场经理），那么您可以选择这些经理角色并允许他们审核清单。

您无需逐个搜索和添加经理姓名。 学习者注册清单课程时，系统会自动向对方的经理/商店经理发送通知，以便他们与任何选定的讲师一起审核。 此工作流程使作者无需提及个别经理的姓名即可轻松实现。

在上面提供的示例屏幕截图中，选择“**[!UICONTROL +商店经理]**”选项将自动启用与学习者一致的非层级经理以查看清单。 请注意，此处的“store”将由管理员定义的活动字段替换。
...
![证书批准](assets/pending-task-managers.png)

*认证批准*

单击“审核清单”后，审核者即可完成评估。

![查看待处理的清单审核项目](assets/evaluation-checklist.png)
...
* **草稿** - 作者完成课程创建并保存后的效果。 在此状态下，学习者尚无法使用该课程。
* **已发布** - 作者完成课程发布。 在此状态下，学习者可注册课程。在此状态下，您也可以编辑课程。
* **已弃用** - 发布课程后，如果作者不希望课程继续显示在学习者的课程目录中，可将其移至弃用状态。
* **已删除** - 处于已删除状态的课程是指该课程从 Adobe Learning Manager 应用程序中完全删除。 只有处于“草稿”或“弃用”状态的课程作者可以删除课程。
...
作者还可对课程进行排序，以便查找所需课程。单击排序方式&#x200B;]**，然后选择**[!UICONTROL &#x200B;字母升序、字母降序、课程创建日期、课程更新日期和课程效果。
...
1. 单击个人资料图片，然后选择“管理员”。
1. 在“管理员”模式下，单击左窗格中的&#x200B;**[!UICONTROL “课程”]**。在此页面上，您可以查看学习管理器帐户中所有作者创建的所有课程。
...
1. 在“注册学习者”对话框的右上角，会显示已选中&#x200B;**“默认实例”**&#x200B;选项。作者创建课程后，会立即创建课程的默认实例。

   ![](assets/default-instance.png)

   *查看课程的默认实例*

1. 在“包含学习者”字段中输入学习者姓名，然后选择学习者。您还可在此处添加用户组。如果您想注册学习管理器帐户中的所有学习者，请开始键入所有学习者。 您还可注册团队中的学习者。
...
1. 在 Captivate 中，单击“发布&#x200B;]**”**[!UICONTROL >**[!UICONTROL “发布到学习管理器]**”。
...
课程效果分数可以帮助作者评估未能满足学习者需求的课程，并对它们作出相应修改。课程效果评估了课程对于学习者是否有帮助。它结合了学习者针对课程内容提出的反馈、课程测验结果和经理根据对课程的学习情况对学习者进行评估的反馈。
...
若要了解如何创建和管理认证和学习计划，请参阅  [认证](/help/migrated/administrators/feature-summary/certifications.md) 和  [学习计划](/help/migrated/administrators/feature-summary/learning-programs.md)。
...
1. 打开课程。
1. 在左侧窗格中，单击“设置&#x200B;]**”**[!UICONTROL >**[!UICONTROL “编辑]**”。
...
可以通过目录来实现。 默认目录包含默认添加到学习管理器的所有课程。
...
**先决条件：**&#x200B;管理员必须在管理应用程序的“设置”>“常规&#x200B;**”中**&#x200B;启用“多次尝试&#x200B;**”选项**。
...
+++能否下载已上传到 Adobe Learning Manager 上的内容来修改内容？

否，上传到学习管理器的内容是已发布的 zip 文件，不是源文件。 因此，即使下载了内容，也无法在创作工具中进行编辑。 您需要源文件来编辑内容。
