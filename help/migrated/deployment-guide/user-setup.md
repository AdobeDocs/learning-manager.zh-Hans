...
1. 在**中&#x200B;[!UICONTROL **用户**]**page，单击**[!UICONTROL **外部**]**在左侧导览窗格中。 系统会显示外部用户页面，其中包含外部用户列表（如有）。
...
可随时通过选择“继续”选项撤销暂停。点击**[!UICONTROL **动作**]**位于页面的右上角，然后选择 **[!UICONTROL 继续]**.
...
1. 在“添加用户”弹出对话框中，指定用户的以下详细信息：
   ...
   * **[!UICONTROL 名称]** **[!UICONTROL ：]** 指定员工或内部用户的姓名。 此字段为必填项。

   * **[!UICONTROL 电子邮件]** **[!UICONTROL ：]** 指定员工的电子邮件ID。 此字段为必填项。

   * **[!UICONTROL 个人资料]** **[!UICONTROL ：]** 指定员工的职务或职务。

   * **[!UICONTROL **&#x200B;经理姓名&#x200B;**：]** 指定Manager的名称。 应该已将经理添加到此处指定的数据库中。
