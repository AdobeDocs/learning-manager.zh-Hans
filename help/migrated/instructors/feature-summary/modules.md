...
学员可以在系统发送的拒绝通知中看到讲师的评论。 然后，学习者可以通过评论的形式提供更多信息，再重新提交。
...
1. 然后，讲师选择向其分配的活动模块。 在模块的“提交”页面中，讲师单击&#x200B;**“编辑”**。 然后学习者可以输入注释以供拒绝，并启用“显示注释”选项，以便学习者可以在通知中查看注释。
...
1. 学员现在会看到一条通知，通知中会指明其提交的内容已遭拒绝。 讲师的评论也会出现在通知中。
