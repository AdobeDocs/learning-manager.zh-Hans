...
* 示例文件： [role.csv](assets/role.zip)
* 示例文件： [user_role.csv](assets/user-role.zip)
 ...
 <tbody>
  ...
  <tr>
   <td>
    <p>&lt;Entity&gt;</p></td>
   <td>
    <p>确定每个实体类型（如课程、目录等）的访问类型（“完全”、“写入”、“注册”、“报告”、“无”等）。</p></td>
   <td>
    <p>完全</p>
    <p>无</p>
    <p>写入 | 报告</p>
...
通过 csv 创建的自定义角色完全可通过该 csv 进行管理。 这包括添加、修改和删除角色。
