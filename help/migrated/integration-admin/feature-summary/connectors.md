...
连接到同一Workday连接器。 如果两个 Adobe Learning Manager 帐户存在名称相同的技能，则它们会被映射到 Workday 下同一项技能中。 在Workday中更新技能之前，如果两个Learning Manager帐户使用的是同一个Workday帐户，则建议对所有Learning Manager帐户中的技能名称进行更新。
