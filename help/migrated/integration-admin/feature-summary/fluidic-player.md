...
### &#x200B;1. 在集成管理员中创建应用程序 {#createanapplicationinintegrationadmin}
...
### &#x200B;2. 正在检索访问令牌 {#retrievingaccesstoken}
...
### &#x200B;3. 使用公共API检索资源 {#retrieveresourcesusingpublicapi}
...
1. 将访问令牌用作必需的参数。
   ...
   * access_token ：这是安全参数，使用公共API oauth   访问令牌
   ...
   已创建的URL示例； `https://learningmanager.adobe.com/app/player?lo_id="+lo_id+"&access_token="+accToken`
