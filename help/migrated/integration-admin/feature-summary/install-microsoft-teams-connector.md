...
借助此连接器，创建会议时可在 Adobe Learning Manager 中设置 Microsoft Teams 会议组织者。 会议组织者可以管理大厅以决定是否允许用户进入会议，还可以控制 Microsoft Teams 提供的其他会议选项。

**使用自动用户完成同步**

通过用户完成情况自动同步流程，Adobe Learning Manager 管理员可自动获取 Microsoft Teams 会议的完成记录和录制 URL。

## Microsoft Teams 中的角色

如果组织的会议有多位参加者出席，您可以为每位参加者分配角色，以便他们知道自己在会议中的权限。
...
## 创建开发人员 E5 Microsoft 帐户&lt;开发人员/可选>

如果您有 Office 365 E3 或 Office 365 E5，则可以访问 Microsoft Teams 连接器。 建议使用 Office 365 E5。

* 访问[Microsoft计划页面](https://www.microsoft.com/en-in/microsoft-365/enterprise/compare-office-365-plans?&ef_id=CjwKCAjw8cCGBhB6EiwAgORey9Tjrae-dyAsBrzvXdVJ5WCcoQ55wySzUBMoo-EkPt7CoIqAtcWc0xoC9RcQAvD_BwE:G:s&OCID=AID2100137_SEM_CjwKCAjw8cCGBhB6EiwAgORey9Tjrae-dyAsBrzvXdVJ5WCcoQ55wySzUBMoo-EkPt7CoIqAtcWc0xoC9RcQAvD_BwW e:G:s&lnkd=Google_O365SMB_Brand&gclid=CjwKCAjw8cCGBhB6EiwAgORey9Tjrae-dyAsBrzvXdVJ5WCcoQ55wySzUBMoo-EkPt7CoIqAtc0xoC9RcQAvD bwE)。 在该网页上，您可以购买E3或E5帐户，也可以单击“免费试用”。
* 提供所需信息，创建帐户。
...
1. 单击&#x200B;**[!UICONTROL “新注册”]**，输入以下详细信息，注册应用程序：
...
1. 单击&#x200B;**[!UICONTROL “新建客户端密钥”]**，添加以下详细信息：
...
## 获取 Microsoft Teams 连接器的访问权限

1. 访问[Microsoft Azure门户](https://portal.azure.com/)。
1. 使用之前创建的 Microsoft E5 登录。
1. 搜索 **Azure Active Directory**。
1. 单击&#x200B;**[!UICONTROL “应用程序注册”]**。
1. 单击在上节中创建的应用程序。
...
1. 单击&#x200B;**[!UICONTROL “授予 Adob&#x200B;&#x200B;e 管理员访问权限”]**。
...
+++组织者是否应该同时注册 Adobe Learning Manager 和 Microsoft Teams？ 

是的，组织者应该同时注册 Adobe Learning Manager 和 Microsoft Teams。 此外，组织者必须属于集成管理员应用程序中配置的同一Microsoft租户。

+++

+++演示者是否应该同时注册 Adobe Learning Manager 和 Microsoft Teams？ 

是的，演示者应该同时注册 Adobe Learning Manager 和 Microsoft Teams。 演示者必须具有 Azure Active Directory ID（可以与组织者属于同一租户，也可以属于任何其他租户）。 此外，即使是匿名用户（仅使用用户名而不是Active Directory登录的用户），也可以在会议期间由组织者或现有演示者指定为演示者。

+++

+++Microsoft Teams 可提供会议、网络研讨会和现场活动等功能。 Teams 连接器支持哪一种功能？ 

目前，Teams 连接器仅支持 Microsoft Teams 中的会议功能。 有关详细信息，请参阅此[文档](https://docs.microsoft.com/zh-cn/microsoftteams/quick-start-meetings-live-events)。
