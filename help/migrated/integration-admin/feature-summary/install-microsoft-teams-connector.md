...
要通过运行PowerShell脚本来配置Microsoft Teams连接器的应用程序访问策略，请按照以下步骤操作  [文档](https://docs.microsoft.com/zh-cn/graph/cloud-communication-online-meeting-application-access-policy).
...
用于录制会话的 API 为受保护 API。 要访问此 API，必须向 Microsoft 请求访问权限。 有关更多信息，请参阅此文档  [文档](https://docs.microsoft.com/zh-cn/graph/teams-protected-apis).
...
请参见  [文档](https://support.microsoft.com/zh-cn/office/roles-in-a-teams-meeting-c16fa7d0-1666-4dde-8686-0a0bfe16e019) 从Microsoft获得Microsoft Teams支持的各种角色和功能。
...
目前，Teams连接器仅支持Microsoft Teams中的会议。 有关更多信息，请参阅此文档  [文档](https://docs.microsoft.com/zh-cn/microsoftteams/quick-start-meetings-live-events).
