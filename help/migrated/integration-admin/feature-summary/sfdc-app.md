...
Salesforce™ 是最受销售和营销团队青睐的客户关系管理 (CRM) 解决方案之一。 通过在 Salesforce 中使用 Adobe Learning Manager 应用程序，用户可以在其 Salesforce 界面内直接访问所有学习内容。 用户可以在 Salesforce 中访问指定的学习内容，如课程、学习计划和工作辅助等。 用户还可以收到管理员发来的相关注册和公告的通知信息。
...
要将 Adobe Learning Manager 通知组件添加到主页布局，请按照以下步骤操作：
...
要了解如何登录 Adobe Learning Manager 应用程序以及如何在 Salesforce 中以学习者身份使用此应用程序，请参阅 [Salesforce 应用程序帮助内容](../../learners/feature-summary/sfdc-app.md)。
