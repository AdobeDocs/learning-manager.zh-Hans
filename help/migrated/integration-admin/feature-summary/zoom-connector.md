...
| 范围描述 | 缩放范围 |
|---|---|
| 查看所有用户会议 | 会议:read:管理员 |
| 查看和管理所有用户会议 | 会议:write:管理员 |
| 查看报告数据 | 报告:read:管理员 |
| 查看所有用户信息 | 用户:read:管理员 |
| 管理用户 | 用户:write:管理员 |
| 添加会议注册者 | 会议:write:注册者：管理员 |
| 列出所有会议注册者 | meeting:read:list_registrants：admin |
| 管理子帐户会议 | 会议:write:会议：主会议 |
| 查看会议参与者报告 | 报告:read:list_meeting_participants：admin |
