...
>[!NOTE]
>
>学习者还可以从 Apple Store 安装学习管理器 iPad 应用程序，从 Google Play 安装学习管理器 Android 应用程序，并在移动设备上访问课程。 所有学习者角色功能也可用于应用程序。学习者还可以离线参加课程并能在重新联机后实现无缝对接访问。有关更多信息  [，请参阅 iPad 和 Android 平板电脑用户](ipad-android-tablet-users.md) 功能。
...
它结合了学员对课程内容提出的反馈、学员的课程测试结果以及经理根据学员对课程的学习情况给予的评估反馈。
...
单击“排序方式”，然后从下拉菜单中选择相关选项，即可按相关性、名称或发布日期对课程进行排序。

在搜索结果页面上，您可以根据课程的持续时间&#x200B;**和**&#x200B;课程的形式&#x200B;**对**&#x200B;课程进行过滤。您可借此更灵活地搜索课程，并确保找到适合您的课程。
...
但是，您可以选择将鼠标移到目录下列出的任何课程上并单击“浏览”来完整浏览该课程。 此时会显示注册页面。 单击页面右上角的“注册”将课程添加到“课程”列表。
...
>[!NOTE]
>
>如果学习者同时注册两个不同的会话或时间重叠，则应该会看到冲突消息。

## 学习者工作流程

作为学习者，您只能在注册后对课程进行评分。 您可以在主页、我的学习&#x200B;**页面和**&#x200B;目录中&#x200B;**查看任何课程**&#x200B;的平均&#x200B;**星级。**

1. 以学习者&#x200B;**身份**&#x200B;登录。这将加载 **主页**。

1. 您可以通过在搜索栏中输入课程名称来搜索课程。 或者，您也可以单击左侧窗格中的“我的学习&#x200B;**”或**“目录&#x200B;**”**，从显示的课程列表中进行选择。

1. 选择课程后，单击“注册&#x200B;]**”。**[!UICONTROL 

   ![](assets/cp-sr-enroll.png)
   *注册课程*

1. 选择星级对相应课程进行评分，1 为最差，5 为最好。 然后单击“提交&#x200B;]**”。**[!UICONTROL 
...
系统可以根据平均评分对课程进行排序。 您可以从“目录&#x200B;**”中**&#x200B;右上角的“排序方式”下拉菜单中对案例进行排序。

## 参加课程 {#consumingnbspacourse}

注册课程后，您可以单击课程上的“开始”以开始课程。或者，单击“学习”**[!UICONTROL 选项卡中的课程]****[!UICONTROL 。]**&#x200B;选择要开始的课程。
...
**书签** - 如果任何课程模块具有模块目录，则可以将模块目录中的主题添加为书签以供以后参考。 标记书签后，目录条目旁会显示一个功能区图标。再次单击功能区即可删除书签。
...
**隐藏字幕** - 对于 Adobe Captivate 开发课程，如果在课程开发过程中启用了隐藏字幕，则学习者可以查看字幕。 在播放器底部单击隐藏字幕。隐藏字幕选项仅适用于 Captivate 8.0.2 HTML 内容。对于所有其他类型的模块，隐藏字幕选项不会显示在播放栏上。
...
**导航按钮** 您可以单击上/下箭头，在 PDF、docx 和 pptx 内容的幻灯片之间移动。 滑动箭头可用于在所有类型的内容中移动至后续话题。

**关闭课程** 单击播放器右上角的关闭 (x) 图标即可退出课程。

*退出课程后，您可以单击课程描述页面上的重新访问按钮重新访问课程。*

## 星级评分

只有在注册课程后，学习者才能为课程提供星形反馈。 在课程的“课程概述”页面中，学习者可以将课程评为星级（1 低、5 高）。

![](assets/star-rating.png)
*提供星级评定作为反馈*

学习者将能够选择一颗特定的星（共 5 颗星）并提交评分。 学习者还可以通过单击其他星星来编辑所选内容。 提交后，将显示“感谢您的反馈”消息。

如果学习者要重新提交反馈，可以单击此消息。 “ **提交”** 按钮将重新启用。 学习者可以在注册课程后多次提供星级评定。 系统会一律参考最近的评分。

学习者提供星级后，平均星级评定和提供星级评定的学习者数量就会显示在“课程概述&#x200B;**”页面中**。
...
“内容市场”选项显示在“学习者”应用的左侧窗格中。 单击该选项后，您可以查看所有课程/整个目录和精选播放列表。
...
作为学习者，您可以在“精选播放列表&#x200B;**”部分中表达对整个目录或任何精选播放列表**&#x200B;的兴趣。
...
在学习者应用程序中，所有管理员都有权访问内容市场。 如果管理员撤销了访问权限，学习者将无法看到“内容市场”选项卡。

只有受管理员邀请的学习者可以浏览“内容市场”。

>[!NOTE]
>
>Internet Explorer 11 不支持 Content Marketplace。

所有筛选器和其他选项都将在以下视频中展示。

### 预览内容

您可以浏览并预览课程并查看符合您学习需要的课程。 **单击预览**&#x200B;按钮并查看课程预览。预览时间为两分钟。
...
内容中心允许管理员和主题专家 （SME） 从学习者应用程序中入围所需的播放列表。 入围后，管理员可以下载购买申请表并与 Adobe 销售代理共享。

管理员可以邀请 SME 将其感兴趣的播放列表列入候选清单。

内容中心以学习者角色适用于所有管理员。 管理员允许 SME 将其有兴趣购买的播放列表列入候选清单。
...
1. 使用单选按钮选择是要查看所有课程还是包含未选定实例的课程。 请注意，学习者完成实例后无法切换到另一个实例。
...
## 查看和参与讨论 {#viewingandpariticpatingindiscussions}
...
帖子会立即显示在“讨论”选项卡中。您可以按“最新在前”或“旧在前”的顺序对帖子进行排序，以及删除自己发布的帖子。 即使在取消课程注册后，您仍可查看所有帖子以及删除您编写的帖子。
...
**已弃用** - 发布课程后，如果作者不想让课程显示在学习者的课程目录中，可将其移动至弃用状态。

**已删除** - 处于已删除状态的课程是指该课程从 Adobe Learning Manager 应用程序中完全删除。 课程只有处于“草稿”或“弃用”状态时，作者才能将其删除。
