...
下载并安装此应用程序后，请使用您的凭据进行登录。 打开 Adobe Learning Manager 移动应用程序时，默认情况下会显示以下屏幕。
...
所有已启用“沉浸式布局”选项的帐户，都有一个支持“沉浸式布局”配置的全新主页。 主页以卡片列表形式组织如下：
...
现有用户在将应用程序更新为最新版本后，首次关闭播放器时会看到反馈弹出窗口。

请注意，系统会匿名收集反馈，此弹出窗口仅对通过应用程序设置中的配置已启用“**共享使用情况数据**”选项的用户显示。

## 下载徽章 {#downloadbadge}

学习者可下载 PDF 和图像格式的徽章。 在“用户配置文件”部分，向下滚动，然后单击任意链接以下载徽章。 已下载的徽章会保存在默认设备文件夹中。 该应用程序允许您在下载完成后立即打开文件夹或文件。
...
| **区域** | **不支持** |
|---|---|
| 讨论区 | 创建讨论区、编辑讨论区、复制 URL、删除、报告、排序、筛选 |
| 帖子 | 创建投票类型帖子、编辑、为帖子添加多个附件、复制 URL、置顶 |
...
点击屏幕左上角的 ![](assets/hamburger.jpg) 菜单可查看您的个人资料、通知以及帐户设置。
...
1. 要扫描二维码，请点击屏幕左上角的 ![](assets/hamburger.jpg)。
1. 点击&#x200B;**“扫描二维码”**。
...
要创建帖子，请点按屏幕右下角的![添加图标](/help/migrated/learners/feature-summary/assets/prime-add.png)。
...
将图片、文档、音频或视频文件共享到任意讨论区，以便讨论区其他成员查看您的帖子并开展互动。 要共享媒体，
...
如果您通过 LinkedIn 应用程序参加课程，则系统不会在 Adobe Learning Manager 中跟踪您的进度。 因此，建议在浏览器中而不是在LinkedIn学习应用程序中启动课程。
...
开始学习某一课程后，学习者可以看到&#x200B;**“文件提交”**&#x200B;状态显示为“待处理”，旁边还有文件上传链接，如下图所示。
...
上传文件后，状态更改为&#x200B;**等待批准。**。讲师随后查看[待处理提交](/help/migrated/instructors/feature-summary/learners.md)的列表，并通过讲师Web应用程序批准或拒绝提交。

讲师批准提交内容后，学习者移动应用程序中的状态即变更为&#x200B;**“已批准”**。

<!--![](assets/approved.jpg)-->

讲师拒绝提交内容后，学习者移动应用程序中的状态即变更为&#x200B;**“已拒绝”**。
...
用户可以通过单击绿色栏上的&#x200B;**查看联机内容**&#x200B;按钮切换回联机模式。 在切换回在线模式时，设备中的内容会进行同步。
