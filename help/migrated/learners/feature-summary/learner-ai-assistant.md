...
- **管理员控件**
   ...
   - 按用户组控制访问
   - 选择为AI响应包含的目录
   - 按照Adobe AI准则接受使用条款要求

## 支持的内容类型

AI助手从分配给您的学习内容中检索信息，包括：
...
Adobe使用可信服务安全地处理您的学习内容。

### 目录和内容源限制

AI助手仅使用管理员明确配置的&#x200B;**内部**&#x200B;目录中的内容。
...
- **外部**&#x200B;目录
- **默认**&#x200B;目录
- 第三方内容库（例如，LinkedIn Learning或Go1）

如果您无法访问课程或工作辅助，则AI Assistant将不会显示相应内容中的信息，并且也无法访问引用链接。

## 用例

### 技术学习者

Sarah是一名销售工程师，正在学习显卡知识。 她需要快速了解技术规格和优势，以自信地回答客户的问题。
...
管理员选择哪些用户组和&#x200B;**内部**&#x200B;目录可以访问AI Assistant功能。 请确保您分配的目录仅包含适用于AI响应和引文的学习内容，并且这些目录为&#x200B;**内部**（而非&#x200B;**共享**、**已获取**&#x200B;或&#x200B;**外部**）。

在配置AI Assistant之前，请确认您具有管理员凭据，并且已确定哪些用户组和目录应具有访问权限。
