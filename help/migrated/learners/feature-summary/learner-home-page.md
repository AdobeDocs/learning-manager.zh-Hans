...
jcr-language: en_us
title: 学习者主页
description: 如果管理员启用沉浸式布局，学习者在登录应用程序后，即可看到经过全面改进的用户界面。
...
展示带有嵌入式 URL 的视频或图片轮播。 [管理员能以标头形式上传任何图像或视频](../../administrators/feature-summary/announcements.md#masthead)资源，并针对一组学习者设置其可见性。
...
显示学习者已参加的培训。 这些培训会以水平排列的卡片显示。 您可以单击右侧或左侧按钮浏览课程。
...
在学员注册参加此课程后，系统只会将按分数划分的外部技能添加至用户资料技能中。 此外，学员还可以搜索、选择外部技能，并将其添加至用户资料中。如果学员是首次登录学员应用程序，并且其中已包含学员的技能，则系统将在“我的用户资料”中显示这些技能。
...
如果您想显示帐户中的所有技能，请启用&#x200B;**显示我的帐户中包含培训的技能**&#x200B;选项。
