...
同样，Adobe Learning Manager 社交学习功能允许用户通过分享各种学习内容来进行相互交流。

此平台上可以分享的内容包括视频、音频、屏幕截图、文本、问题和投票。 用户还可以使用&#x200B;**分享至社交**&#x200B;书签工具与同行共享自己的在线学习内容。 有关更多信息，请参阅[分享至社交学习](share-to-social.md)。

用户还可借助 **Adobe Learning Manager 桌面应用程序**&#x200B;将内容发布到相应的讨论区。 有关详细信息，请参阅[Adobe Learning Manager桌面应用程序](../adobe-learning-manager-app-for-desktop.md)。
...
1. 选择要发布的内容类型：文本、问题、视频、音频、投票和屏幕截图。 现有内容可以从用户系统或 Adobe Learning Manager 桌面应用程序的图库上传。
   ...
   使用 Adobe Learning Manager 桌面应用程序录制视频或屏幕、音频或截取屏幕截图。 有关更多信息，请参阅 [Adobe Learning Manager 桌面应用程序](../adobe-learning-manager-app-for-desktop.md)。

   <!--![](assets/types-of-post-03.png)-->

1. 搜索与帖子相关的讨论区或技能。 如果讨论区不存在，单击&#x200B;**[!UICONTROL 创建新讨论区]**。
...
1. 在弹出的对话框中，填写详细信息，选择以下讨论区类型：
   ...
   * **受限** — 只有讨论区所有者、管理员和讨论区版主可以创建帖子。 其他用户可以通过评论/回复、点赞/拍砖等操作进行参与。
...
学习者可在列表视图中查看所有讨论区。 登录您的学习者应用，在“社交学习”页面中单击相应按钮，如下所示：
...
您可以从“帖子”、“评论”或“回复”部分下载相关内容。 一次只能下载一个文件。

务必确保内外部两类用户均能下载相关内容。

帖子、评论或回复的搜索结果中也会显示“下载”按钮。
...
1. 单击帖子右上角的折叠菜单图标并单击&#x200B;**[!UICONTROL 添加到我的故事]**。
...
创建帖子时，如果不存在可用于发布帖子的相关讨论区，请单击[“创建新讨论区”](social-learning-web-user.md#Creatingcontentasapost)。  要查看、编辑、删除、举报、复制 URL 以及将讨论区添加至讨论区收藏列表，请执行以下步骤：
