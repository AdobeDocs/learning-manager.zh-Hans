...
推荐引擎的核心是由Learning Manager的新增功能驱动的 **[!UICONTROL 课程排序算法]**. 该算法使用来自数百万用户的5000万数据点和5年汇总学习数据，根据注册可能性对课程进行排名。 此排名可确保优先向学习者显示大多数可注册的课程。

## 关键词

Learning Manager全新的基于AI的推荐引擎为学习领导者提供了可配置的基于参数的推荐系统，用于为学习者打造个性化体验。

参数为 —  **产品/主题**， **角色**&#x200B;和 **色阶**. 另外，您还可按需重命名这些参数。 因此，“products”可以成为“topics”，或者“roles”可以成为“region”。
