...
| 培训 ID | 培训类型 | 培训名称 | 产品 | 角色 | 级别 | 标签 | 技能 |
|---|---|---|---|---|---|---|---|
...
一旦激活了PRL建议，便无法恢复为以前的状态。 在激活期间，Adobe Learning Manager会显示一个确认提示，以通知您更改是永久性的。 在建议案变为实时之前，您仍然可以撤消或修改所做的更改。

![上线](assets/computerdescription-automatically.png)
*实时提出建议*

![上线](assets/recommendations-irreversible.png)
*建议警告*
...
![个保存的卡片](assets/cards-saved-by-me.png)
*保存的卡片*
