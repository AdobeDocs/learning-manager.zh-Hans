...
* **更快地获取知识：**&#x200B;您可以立即获得问题的答案，而无需在多个课程或文档中进行导航。
* **更高的参与度：**&#x200B;对话互动使学习体验更自然、直观且易于访问。
* **更好地理解：**&#x200B;您可以提出后续问题以阐明概念并更详细地探索主题。
* **可扩展的学习支持：**&#x200B;由AI驱动的自动化响应最大限度地减少对主题专家和支持团队的依赖。

了解有关学习者[AI Assistant](/help/migrated/learners/feature-summary/learner-ai-assistant.md)的更多信息。
...
* **全球培训：**&#x200B;以多种语言提供带有字幕的视频内容，从而吸引国际学习者。
* **辅助功能合规性：**&#x200B;为听障用户提供首选语言的字幕。
* **更快的本地化：**&#x200B;通过自动生成和翻译VTT文件，减少手动工作并加快内容推广。
* **一致的体验：**&#x200B;确保所有学习者都收到相同的信息，而不考虑其语言为何。

### 主要功能

* **自动VTT生成：**&#x200B;上传视频或音频文件，然后自动生成采用原始语言的VTT字幕。
* **多语言翻译：**&#x200B;将字幕翻译为39种支持的非英语语言中的任意一种。
* **应用程序内审阅和编辑：**&#x200B;在发布之前审阅、编辑和下载VTT文件。
* **通知：**&#x200B;在VTT生成和翻译完成时接收应用程序内通知。
* **顺利发布：** Publish为学习者最终确定了字幕，供其使用所选语言进行访问。
