...
有关更多信息，请参阅[适用于 Microsoft Teams 的 Adobe Learning Manager 应用程序](/help/migrated/adobe-learning-manager-app-microsoft-teams.md)。
...
* “技能”页面上新增“讲师”列。 该列会显示与技能相对应的讲师人数。 单击“讲师”列中的数字会出现弹窗，其中会显示分配给某项技能的讲师人数。
...
管理预订讲师和教室中的冲突或虚拟教室中的冲突。 向课程分配讲师之前，如需了解任意讲师的可用时间和日期，请使用“计划助手”。
...
从 Google Play 商店和 Apple App Store 处下载移动应用程序。 系统将提示旧版应用程序的用户下载并安装新应用程序。
...
* 搜索选项：此功能允许您指定搜索参数，例如课程元数据、标签和指定搜索范围的技能。
...
在“设置”>“显示过滤器面板”中，面向管理员新增一个名为“群组”的新选项。 启用“群组”后，“学习者”主页上将显示“群组”过滤器。 然后，学习者可以选择根据用户组查看课程。
...
学习者单击链接或单击“转到目录”按钮后，将被重定向到课程目录页面。 然后，学习者查看用户组列表，以根据目录和“我的学习”页面中的用户组进行筛选。
...
如果学习者的会话存在冲突，“概述”页面会弹出关于注册的窗口。 如果从目录页面或概述页面进行注册，且学习者已经具有存在冲突的会话，则会触发包含冲突会话详细信息的冲突弹窗。 即使学习者有冲突的会话，也可以注册新会话。
...
在从学习者或管理员应用程序完成课程的任何实例之前，您将无法切换实例。
...
他们可以在注册学习路径或认证后，单击课程页面上的“查看实例”，然后切换实例。
...
有关更多信息，请参阅[讲师利用率报告](/help/migrated/administrators/feature-summary/reports.md#instructor-utilization-report)。
...
在“创建公告”对话框中，默认选中“以电子邮件发送”和“培训”选项以及实例。 指定主题、输入消息，然后单击“保存”。
...
有关更多信息，请参阅[公告](/help/migrated/administrators/feature-summary/announcements.md#as-email)。
...
有关更多信息，请参阅 [API 引用文档](https://captivateprime.adobe.com/docs/primeapi/v2/)。
...
| 搜索和筛选城市 | filter.cityName=city_name<br>还支持以逗号分隔的城市列表 | GET/primeapi/v2/search |
...
如需了解 Learning Manager 网页版应用程序和设备应用程序的当前和往期版本，请参阅[发行说明](/help/migrated/release-note/release-notes.md)。
