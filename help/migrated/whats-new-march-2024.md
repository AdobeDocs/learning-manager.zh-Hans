...
有关配置连接器的详细信息，请在Adobe Learning Manager[&#128279;](integration-admin/feature-summary/connectors.md)中查看连接器。
...
有关产品中所有已弃用API的累积列表，请在Adobe Learning Manager[&#128279;](api-deprecations-list.md)中查看API弃用。
